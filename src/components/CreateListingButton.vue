...
<template>
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center">
        <div class="bg-white rounded-lg p-6 shadow-lg max-w-md w-full">
            ...
            <button @click="emit('close')"> <X class="hover:rotate-180 cursor-pointer hover:bg-gray-300 transition-all duration-200  rounded-lg w-6 h-6"/> </button>
            ...
            <div class="gap-10 mt-7 flex flex-row justify-center items-center">
                <button class="bg-green-400 p-4 cursor-pointer hover:p-6 hover:shadow-2xl hover:bg-green-300 transition-all rounded-2xl" @click="createListing()">Confirmar</button> 
                <button class="bg-red-400 p-4 cursor-pointer hover:p-6 hover:shadow-2xl hover:bg-red-300 transition-all rounded-2xl" @click="emit('close')">Cancelar</button>
            </div>
        </div>
    </div>
